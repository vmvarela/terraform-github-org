...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_sub"></a> [sub](#module\_sub) | vmvarela/suborg/github | 0.1.2 |
...
| <a name="input_defaults"></a> [defaults](#input\_defaults) | (Optional) Repositories default configuration (if empty) | `any` | `{}` | no |
...
| <a name="input_organization"></a> [organization](#input\_organization) | (Required) Org name. | `string` | `null` | no |
| <a name="input_repositories"></a> [repositories](#input\_repositories) | (Optional) Repositories | `any` | `{}` | no |
...
| <a name="input_settings"></a> [settings](#input\_settings) | (Optional) Repositories fixed common configuration (cannot be overwritten) | `any` | `{}` | no |
